...
ATV-Teams should get stricter about what counts as finished work. Watchdogs, recovery actions, and review gates keep execution moving toward clear outcomes like merged code, published artifacts, shipped docs, or explicit decisions instead of vague status updates.

### ✅ MCP Tool Gateway & Apps (governed tool access)

MCP tools and apps should be available through a governed gateway instead of unmanaged direct access. ATV-Teams can apply company boundaries, approval gates, and activity attribution while giving agents the tools they need.
...
Existing ticket systems should be able to feed work into ATV-Teams without becoming the agent control plane themselves. Asana, Linear, and Jira can act as familiar on-ramps while ATV-Teams owns execution, governance, and outcomes.
