...
```sh
node cli/node_modules/tsx/dist/cli.mjs cli/src/index.ts secrets doctor --company-id {companyId}
```
...
```sh
node cli/node_modules/tsx/dist/cli.mjs cli/src/index.ts secrets declarations --company-id {companyId}
```
