...
function sourceMeta(sourceBadge: CompanySkillSourceBadge, sourceLabel: string | null) {
  ...
  switch (sourceBadge) {
    ...
    case "paperclip":
      return { icon: Paperclip, label: sourceLabel ?? "ATV-Teams", managedLabel: "ATV-Teams managed" };
    default:
...
function CompatChip({ compatibility }: { compatibility: CompanySkillCompatibility }) {
  ...
  const map = {
    unknown: {
      ...
      tooltip: "ATV-Teams could not validate this skill as Agent Skills markdown. Install at your own risk.",
...
function buildDiscoveryCards(
  ...
  for (const entry of catalog) {
    ...
    cards.push({
      ...
      name: entry.name,
      slug: entry.slug,
      author: entry.packageName ?? "ATV-Teams",
...
export function CompanySkills() {
  ...
  const studioDescription = studioForkFromId
    ...
    : "Create an editable company skill in the ATV-Teams workspace.";
  return (
    <>
      {policyDenial.denial ? (
