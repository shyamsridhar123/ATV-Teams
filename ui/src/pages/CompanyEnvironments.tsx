          ...
          <div className="min-w-0 space-y-1">
            ...
            <div className="text-xs text-muted-foreground">
              ...
              <span
                ...
                title={templateRef
                  ? `Provider ${activeTemplate.templateKind} ref ${templateRef} (ATV-Teams template ${activeTemplate.id})`
                  : activeTemplate.id}
              >
        ...
        <div className="rounded-md border border-border bg-background" data-testid="managed-environment-form-page">
          <div className="border-b border-border/60 px-6 pb-4 pt-6">
            ...
            <p className="mt-1 max-w-3xl text-sm text-muted-foreground">
              {editingEnvironment.description ?? "Your agent runs in a sandbox managed by ATV-Teams."}
            </p>
            <p className="mt-1 max-w-3xl text-xs text-muted-foreground">
              This environment is provisioned and maintained for you. You can add environment
              variables for your agents; its name and configuration are managed by ATV-Teams.
            </p>
          </div>
      ...
      (mode === "create" || (editingEnvironment && !isPlatformManagedEnvironment(editingEnvironment))) ? (
        ...
        <div className="rounded-md border border-border bg-background" data-testid="environment-form-page">
          <div className="border-b border-border/60 px-6 pb-4 pt-6">
            ...
            <p className="mt-1 max-w-3xl text-sm text-muted-foreground">
              Configure a reusable execution target for your agents. Saved changes affect future runs; ATV-Teams may start fresh sessions or sandbox leases after environment config changes.
            </p>
          </div>
