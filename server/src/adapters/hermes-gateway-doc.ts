...
- Private overlay: agentDefaultsPayload.apiBaseUrl = "http://hermes-host.tailnet-name.ts.net:8642"; agentDefaultsPayload.paperclipApiUrl = "http://paperclip-host.tailnet-name.ts.net:3100". Add the Paperclip hostname with node cli/node_modules/tsx/dist/cli.mjs cli/src/index.ts allowed-hostname <host> when authenticated/private mode requires it.
