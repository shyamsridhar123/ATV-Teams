...
node cli/node_modules/tsx/dist/cli.mjs cli/src/index.ts secrets create \
...
```bash
node cli/node_modules/tsx/dist/cli.mjs cli/src/index.ts skills create \
  --company-id <company-id> \
  --name "Paperclip Page" \
  --slug paperclip-page \
...
```bash
node cli/node_modules/tsx/dist/cli.mjs cli/src/index.ts skills agent sync <agent-id-or-shortname> \
  --company-id <company-id> \
