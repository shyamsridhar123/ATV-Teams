...
- desired skills are stored in ATV-Teams
...
- ATV-Teams reconciles desired skills into `~/.cursor/skills`
...
- ATV-Teams reconciles desired skills into `~/.gemini/skills`
...
- ATV-Teams reconciles desired skills into `~/.pi/agent/skills`
